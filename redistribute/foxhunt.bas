...
3001RETURN
4000HCOLOR4:GOSUB1000:HLINE(21,21)-(33,33),PSET,B:HGET(21,21)-(33,33),1:GOSUB8000:HGET(21,21)-(33,33),2:FORX=21TO277STEP16:HPUT(X,21)-(X+12,33),1:NEXT:HGET(21,21)-(289,33),1:FORY=37TO165STEP16:HPUT(21,Y)-(289,Y+12),1
