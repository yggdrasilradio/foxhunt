...
2POKE&HEF6B,&H12:POKE&HF015,&H21:POKE&HFFD9,0:HSCREEN2
...
3001RETURN
4000HCOLOR4:Y1=21:Y2=Y1+12:FORJ0=1TO10:X1=21:X2=X1+12:FORI0=1TO17:HLINE(X1,Y1)-(X2,Y2),PSET,B:X1=X1+16:X2=X1+12:NEXT:Y1=Y1+16:Y2=Y1+12:NEXT:RETURN
