...
3001RETURN
4000HCOLOR4:GOSUB1000:IFG=0 THENHDRAW"BM21,21R12D12L12U12":HGET(21,21)-(33,33),1:GOSUB8000:HGET(21,21)-(33,33),2:FORX=21TO277STEP16:HPUT(X,21)-(X+12,33),1:NEXT:HGET(21,21)-(289,33),1:G=1
4001FORY=21TO165STEP16:HPUT(21,Y)-(289,Y+12),1:NEXT:GOSUB2000:RETURN
...
7006RETURN
8000HDRAW"BM22,33C4U12R10D12BLC7L8BM23,22C4RC7RC4R5C7RC4RBM23,23RC7RC4R5C7RC4RBM23,24C7RC1RC7RC4R3C7RC1RC7R0BM23,25R8DL8":HDRAW"BM23,27RC1R2C7R3C1R2C7R0BM23,28C1RBR2RC7RC1R0BR2RBM23,29R4C7RC1R3BM23,30C4RC1R3C7RC1R3C4RBM23,31R2C7RC1RC7RC1RC7RC4R"
8001HDRAW"BM23,32RC7R2BR2R3C4R":RETURN
