...
3000T=(T+1)AND7:X=24+(I-1)*16-3:Y=24+(J-1)*16-3:IFT AND2 THENHLINE(X,Y)-(X+12,Y+12),PRESET,B ELSEHCOLOR4:HLINE(X,Y)-(X+12,Y+12),PSET,B:GOSUB7000
3001RETURN
4000HCOLOR4:GOSUB1000:HLINE(21,21)-(33,33),PSET,B:HGET(21,21)-(33,33),1:GOSUB8000:HGET(21,21)-(33,33),2:FORX=21TO277STEP16:HPUT(X,21)-(X+12,33),1:NEXT:HGET(21,21)-(289,33),1:FORY=21TO165STEP16:HPUT(21,Y)-(289,Y+12),1
...
7006RETURN
8000RESTORE:FORY=22TO33:FORX=22TO32:READC:HCOLORC:HSET(X,Y):NEXT:NEXT:RETURN
8001DATA4,4,7,4,4,4,4,4,7,4,4,4,4,7,4,4,4,4,4,7,4,4,4,7,1,7,4,4,4,7,1,7,4,4,7,7,7,7,7,7,7,7,7,4,4,7,7,7,7,7,7,7,7,7,4,4,7,1,1,7,7,7,1,1,7,4,4,1,1,0,1,7,1,0,1,1,4,4,1,1,1,1,7,1,1,1,1,4,4,4,1,1,1,7,1,1,1,4,4,4,4
8002DATA4,7,1,7,1,7,4,4,4,4,4,7,7,7,0,7,7,7,4,4,4,7,7,7,7,7,7,7,7,7,4
